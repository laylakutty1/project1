...
data2 %>% pivot_wider(names_from = "Genre", values_from="IMDB_Rating")
...
data2 <- data2 %>% rename("movie_title" = "Series_Title")
joined_data <- inner_join(data1, data2, by="movie_title")
